 ...
 *      $.showTopPrompt('Loading is complete'); // or $.showTopPrompt(); Maintaining the
 * original content
 *
 ...
 * Tip:
 * Use <script
 * src="//ajax.googleapis.com/ajax/libs/jqueryui/1.9.1/jquery-ui.min.js"></script>, there
 * will be bounce.
 * 使用<script
 * src="//ajax.googleapis.com/ajax/libs/jqueryui/1.9.1/jquery-ui.min.js"></script>后，出现时会有弹跳效果
 */
;(function($) {
	/**
	 * 是否已初始化过的标志
